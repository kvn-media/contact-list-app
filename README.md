...
Simple Contact List React JS App
...
**Note: on some OS probably need some configuration do to node sass!**

When encounter problem you can try:
- npm audit fix after npm install
- npm rebuild node-sass or sudo npm rebuild node-sass
